...
def cost_pipeline_run(data_path, output_path, outlier_flag, outlier_scenario):
    ...
    reg_proj_0_ann, proj_0_sorted_feat = modeling_regresion_db2(df_proj_0, 'proj_0', 'ann', output_folder)
    reg_proj_0_svm, _ = modeling_regresion_db2(df_proj_0, 'proj_0', 'svm', output_folder)
    reg_proj_0_rf, _  = modeling_regresion_db2(df_proj_0, 'proj_0', 'rf', output_folder)

    reg_proj_1_ann, proj_1_sorted_feat = modeling_regresion_db2(df_proj_1, 'proj_1', 'ann', output_folder)
    reg_proj_1_svm, _ = modeling_regresion_db2(df_proj_1, 'proj_1', 'svm', output_folder)
    reg_proj_1_rf, _  = modeling_regresion_db2(df_proj_1, 'proj_1', 'rf', output_folder)
